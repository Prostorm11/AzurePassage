    ...
    <SafeAreaView style={styles.safeAreaViewStyle}>
      ...
      <NavigationContainer independent={true}>
        <Stack.Navigator>
          ...
          <Stack.Screen name="imagequality" component={AppImageQualityScreen} options={{ headerShown: false }} />
          <Stack.Screen name="currency" component={CurrencySelectionScreen} options={{ headerShown: false }} />
